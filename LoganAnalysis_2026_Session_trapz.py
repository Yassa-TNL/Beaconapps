        ...
        for f in input_dir:
            ...
            if mnemonic_responses != 0:
                ...
                if task_type == "MDTO":
                    ...
                    row_dict["mdto_auc_nearestfurthest"] = trapz([row_dict["mdto_target_correct_pct"], row_dict["mdto_foil_incorrect_pct"]], dx=1)
                    row_dict["mdto_auc_ldi"] = trapz([row_dict["mdto_ldi_low"], row_dict["mdto_ldi_high"]], dx=1)
                    ...
                    row_dict["mdts_auc_nearestfurthest"] = trapz([row_dict["mdts_same_correct_pct"], row_dict["mdts_corner_incorrect_pct"]], dx=1)
                    row_dict["mdts_auc_ldi"] = trapz([row_dict["mdts_ldi_low"], row_dict["mdts_ldi_high"]], dx=1)
